...
const TotalStudentsCard = () => {
  ...
  return (
    <div className="students-card min-w-[38%] rounded-[8px] border-[1px] border-solid border-[#1E1E1E1A] p-[2.75rem_1.5rem_3.25rem_1.5rem] inter shadow-[4px_8px_16px_0px_#1E1E1E14]">
      <p className="font-[500] text-[1.5rem]">UMUMIY TALABALAR SONI</p>
